...
{{/*
The robomotion-forms name
*/}}
{{- define "robomotion-forms.name" -}}
{{- default .Chart.Name .Values.forms.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{/*
The robomotion-bots name
*/}}
{{- define "robomotion-bots.name" -}}
{{- default .Chart.Name .Values.bots.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{/*
The robomotion-monitoring name
*/}}
{{- define "robomotion-monitoring.name" -}}
{{- default .Chart.Name .Values.monitoring.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion-forms.fullname" -}}
{{- if .Values.forms.fullnameOverride -}}
{{- .Values.forms.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.forms.name -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion-bots.fullname" -}}
{{- if .Values.bots.fullnameOverride -}}
{{- .Values.bots.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.bots.name -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
