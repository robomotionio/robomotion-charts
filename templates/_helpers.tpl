...
{{/*
The robomotion-app name
*/}}
{{- define "robomotion-app.name" -}}
{{- default .Chart.Name .Values.app.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
The robomotion-user name
*/}}
{{- define "robomotion-user.name" -}}
{{- default .Chart.Name .Values.user.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
The robomotion-user-apps name
*/}}
{{- define "robomotion-user-apps.name" -}}
{{- default .Chart.Name .Values.userApps.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
The robomotion-user name
*/}}
{{- define "robomotion.nginx.name" -}}
...
{{/*
The robomotion-package-service name
*/}}
{{- define "robomotion-package.name" -}}
{{- default .Chart.Name .Values.packageService.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
The robomotion-selenium-hub name
*/}}
{{- define "robomotion-selenium.name" -}}
{{- default .Chart.Name .Values.selenium.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/*
The robomotion-selenium-chrome name
*/}}
{{- define "robomotion-selenium-chrome.name" -}}
{{- default .Chart.Name .Values.selenium.nodes.chrome.name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion-app.fullname" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion-user-apps.fullname" -}}
{{- if .Values.userApps.fullnameOverride -}}
{{- .Values.userApps.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.userApps.name -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion.nginx.fullname" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion-package.fullname" -}}
{{- if .Values.packageService.fullnameOverride -}}
{{- .Values.packageService.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.packageService.name -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion-selenium.fullname" -}}
{{- if .Values.selenium.fullnameOverride -}}
{{- .Values.selenium.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.selenium.name -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "robomotion-selenium-chrome.fullname" -}}
{{- if .Values.selenium.nodes.chrome.fullnameOverride -}}
{{- .Values.selenium.nodes.chrome.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.selenium.nodes.chrome.name -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- printf "%s-%s" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
